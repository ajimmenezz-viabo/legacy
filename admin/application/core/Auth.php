...
class Auth
{
    ...
    public static function checkAuthentication()
    {
        ...
        if (!Session::usuarioInicioSesion()) {
	...
	public static function checarAutenticacion()
    {
        // initialize the session (if not initialized yet)
        Session::init();
    ...
    public static function checkAdminAuthentication()
    {
        ...
        if (!Session::usuarioInicioSesion() || Session::get("user_account_type") != 7) {
     ...
     * If so, then logout.
     */
    public static function checarSesionConcurrida(){
        if(Session::usuarioInicioSesion()){
            if(Session::existeSesionConcurrida()){
