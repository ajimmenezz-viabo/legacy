...
return array(
	...
	'KEY' => 'NikkT5CdrT3uKMP2S9coC4IReKQy8Vjf',
    /**
    ...
    'EMAIL_USE_SMTP' => true,
    'EMAIL_SMTP_HOST' => 'mail.viabo.com',
    'EMAIL_SMTP_AUTH' => true,
    'EMAIL_SMTP_USERNAME' => 'no-responder@viabo.com',
    'EMAIL_SMTP_PASSWORD' => 'OTig#=FM}c0*',
    'EMAIL_SMTP_PORT' => 587,
    'EMAIL_SMTP_ENCRYPTION' => 'tls',
	'EMAIL_IS_HTML' => true,
	'EMAIL_CHARSET' => 'UTF-8',
	/**
	 * Configuracion Viabo API
	 */
	'VIABO_API_CLIENT_KEY' => "LOIK345ZXC4SRIWNDWQE321",
	'VIABO_API_KEY_COMPANY' => "O0ECCS2IJMFTD",
	'VIABO_URL' => 'https://bigonec.westus.cloudapp.azure.com/secure/integrador/API',
	'VIABO_API_CLIENT_KEY_SANDBOX' => "FDERTRGHY5434TRDSSE12356SDFXFLOI",
	'VIABO_API_KEY_COMPANY_SANDBOX' => "O0ECCS2IJMFTD",
	'VIABO_URL_SANDBOX' => 'https://bigonec.westus.cloudapp.azure.com/secure/sandbox/API',
	/**
	 *
	 */
	// 'PAYBOOK_API_KEY' => "2e33df39484ce29ccaae5404265f8807", // Sandbox
	'PAYBOOK_API_KEY' => "f36270422f58d54c6398fe21e60c12f2", // Production
	/**
     * Configuration Infobip itravel SMS
     */
	'SMS_API_KEY_PREFIX' => 'App',
	'SMS_API_KEY' => 'fea19ae930f07b78ae12ed08d09ce4df-40e2ae3a-59f8-4fb3-bb2f-403adc420154',
	'SMS_URL_BASE_PATH' => 'https://vj3wxr.api.infobip.com',
	/**
     * Configuration Infobip Viabo SMS
     */
	/*'SMS_API_KEY_PREFIX' => 'App',
	'SMS_API_KEY' => 'c03b17fd46f63f7a2299c6c654813de5-48075909-b19c-4329-a523-aa19b042c925',
	'SMS_URL_BASE_PATH' => 'r5283m.api.infobip.com',
	*/
    /**
