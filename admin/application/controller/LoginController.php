...
class LoginController extends Controller
{
    ...
    public function index()
    {
        ...
        if (LoginModel::usuarioInicioSesion()) {
            Redirect::home();
        } else {
    ...
    public function iniciarSesion()
    {
        ...
        $login_successful = LoginModel::iniciarSesion(Request::post('usuario'), Request::post('contrasena'), Request::post('recordarContrasena'));
	...
	public function ajaxActualizarComercio($idComercio)
	{
